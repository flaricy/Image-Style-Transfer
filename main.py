...
d2l.set_figsize()
Content_Image = d2l.Image.open(f'./images/{Content_Name}.jpeg').convert("RGB")
Style_Image = d2l.Image.open(f'./styles/{Style_Name}.jpeg')


Content_X, Content_Y = get_contents(IMAGE_SHAPE, DEVICE)
_, Style_Y = get_styles(IMAGE_SHAPE, DEVICE)
Output = train(Content_X, Content_Y, Style_Y, DEVICE, 0.5, 1000, 50)
